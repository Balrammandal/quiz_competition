                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            @endif
                            <form class="form-horizontal" action="{{route('admin::saveSubscription')}}" method="post">
                                <div class="card-body">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="validity" value="{{old('validity')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="validity_type" id="validity_type">
                                            <option value="Days" @if(old('validity_type')=="Days") selected @endif>Days</option>
                                            <option value="Months" @if(old('validity_type')=="Months") selected @endif>Months</option>
                                            <option value="Year" @if(old('validity_type')=="Year") selected @endif>Year</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
