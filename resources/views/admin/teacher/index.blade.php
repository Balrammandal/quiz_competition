...
@section('title',"Admin : Manage Teacher")
@section('content')
    <!-- begin #content -->
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-xs btn-primary fancybox fancybox.iframe"
                           style="float: right;" href="{{route('admin::addTeacher')}}" title="Add New">
    ...
    @push('scripts')
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin::manageTeacher')}}',
                columns: [
