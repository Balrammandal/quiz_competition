...
class datavalue
{
    ...
    public function upload_pic($file, $new_path ,$width ,$height)
    {
        if(is_string($file)){
            try {
                   ...
                   $path = public_path('/uploads/'.$new_path.'/'.$imageName); // add the specific path to save the file
                   try {
                       $supported_image = array('jpg','jpeg','png');
                       if (in_array($extension, $supported_image)){
                           $destinationPath = public_path("uploads/$new_path");  // add the specific path to save the file
                           $thumb_img = Image::make($decoded_file)->resize($width, $height); // resize image
                         ...
                         //  file_put_contents($path, $decoded_file); // save
                           $msg = 'Image type must be jpg ,jpeg or png.';
